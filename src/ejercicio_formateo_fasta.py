...
USAGE
	python ejercicio_formateo_fasta.py
'''
...
# Se abre el for donde cada linea va a ser separada por seqid y la secuencia en si, 
# primero se hace un write del seqid con su > y un salto de linea. Despues se hace otro write 
# donde se añade la secuencia y un salto de linea, asegurandonos de que todo este en mayusculas 
# (y si no cambiandolo a mayusculas) y que no tenga --- (borrandolos si es que hay)
for linea in lineas:
    seqid = linea.split(" ")
